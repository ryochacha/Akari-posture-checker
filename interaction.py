...
class InteractionManager:
    def __init__(self, warning_sound_path="assets/alert.wav", persistent_interval=2, cooldown_sec=5):
        pygame.mixer.init()
        ...
        try:
            ...
            print(f"TTSエンジンの初期化に失敗: {e}")
            self.tts_engine = None
        self.tts_lock = threading.Lock()
        self.is_speaking = False

        self.last_warning_time = 0
        self.warning_cooldown_sec = cooldown_sec
    ...
    def _speak_in_thread(self, text):
        ...
        with self.tts_lock:
            ...
            except Exception as e: print(f"TTSエラー: {e}")
    ...
    def play_persistent_warning(self):
        ...
        if self.warning_sound and current_time - self.last_persistent_warning_time > self.persistent_interval_sec:
            self.warning_sound.play()
            self.last_persistent_warning_time = current_times